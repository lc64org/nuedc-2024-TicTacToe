...
class TestTicTacToe(unittest.TestCase):
	...
	def test_replace_pieces(self):
		...
		print(is_valid, actions)
		self.assertFalse(is_valid)
		self.assertEqual(set(actions), {(0, 0, -1, -1), (0, 2, -1, 1), (2, 0, -1, -1), (-1, 1, 0, 0), (-1, -1, 0, 2), (-1, 1, 2, 0)})
	...
	def test_swap_pieces(self):
		...
		print(is_valid, actions)
		self.assertFalse(is_valid)
		self.assertEqual(set(actions), {(0, 1, -1, 1), (2, 0, -1, -1), (-1, -1, 0, 1), (-1, 1, 2, 0)})
		...
		print(is_valid, actions)
		self.assertFalse(is_valid)
		self.assertEqual(set(actions), {(0, 0, -1, -1), (0, 1, -1, 1), (2, 0, -1, 1), (2, 2, -1, -1),
										(-1, 1, 0, 0), (-1, -1, 0, 1), (-1, -1, 2, 0), (-1, 1, 2, 2)})
